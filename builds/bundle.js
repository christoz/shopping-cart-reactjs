...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventemitter = __webpack_require__(/*! eventemitter2 */ 159);
	
	var _eventemitter2 = _interopRequireDefault(_eventemitter);
	
	var _productsList = __webpack_require__(/*! ./javascripts/productsList */ 160);
	
	var _productsList2 = _interopRequireDefault(_productsList);
	
	var _cart = __webpack_require__(/*! ./javascripts/cart */ 162);
	   ...
	   render: function render() {
	      return _react2.default.createElement(
	         ...
	         _react2.default.createElement(
	            'div',
	            { className: 'l-product' },
	            _react2.default.createElement(_productsList2.default, { items: products })
	         ),
	         _react2.default.createElement(
	            'div',
	            { className: 'l-cart' },
	            _react2.default.createElement(_cart2.default, { setup: settings })
	         )
	      );
	   }
	});
	
	_reactDom2.default.render(_react2.default.createElement(Container, null), document.querySelector('#main'));
...
/* 160 */
/*!*****************************************!*\
  !*** ./src/javascripts/productsList.js ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _productItem = __webpack_require__(/*! ./productItem */ 161);
	...
	var ProductList = _react2.default.createClass({
	  ...
	  render: function render() {
	    var products = this.props.items.map(function (item, i) {
	      return _react2.default.createElement(_productItem2.default, { key: i, img: item.img, code: item.code, name: item.name, price: item.price });
	    });
	    return _react2.default.createElement(
	      'div',
...
/* 161 */
/*!****************************************!*\
  !*** ./src/javascripts/productItem.js ***!
  \****************************************/
/***/ function(module, exports, __webpack_require__) {
	   ...
	   render: function render() {
	      return _react2.default.createElement(
	         ...
	         _react2.default.createElement(
	            'div',
	            { className: 'thumbnail' },
	            _react2.default.createElement('img', { src: this.props.img, className: 'img-responsive' }),
	            _react2.default.createElement(
	               'div',
	               { className: 'caption' },
	               _react2.default.createElement(
	   ...
	   render: function render() {
	      ...
	      var products = this.state.items.map(function (item, i) {
	         ...
	         return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	               'button',
	               { className: 'btn btn-error item-remove', onClick: that.removeItem.bind(that, item, i) },
	               'x'
	            )
	         );
	      });
